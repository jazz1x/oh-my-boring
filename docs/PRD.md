...
**창 중간점 점검 (2026-09-08).** 그날 채점 세션이 10 미만이면 창 종료를 기다리지 않고 **계측 조사**로
전환한다 — §2 의 "48h 내 0건" 조항이 시점 하나만 보는 데 대한 진도판이다. 창 종료 시 하한 미달이면
판정 거부를 기록하고 **정확히 1회, 09-28 까지 연장**한다(지표·하한·임계 무변경). 연장 후에도 미달이면
